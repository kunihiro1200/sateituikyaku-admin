...
# -*- coding: utf-8 -*-
"""
RichTextCommentEditor.tsx v5

根本的なアプローチ変更:
- Range/Selection ベースの挿入を完全に廃止
- カーソル位置をテキストオフセットで保存
- innerHTML を直接操作して挿入
- focus() は一切呼ばない

理由:
- editor.focus() を呼ぶと Chrome はカーソルを先頭にリセットする
- Range を復元しても insertNode が先頭に挿入されてしまう
- innerHTML 操作なら Selection/Range に依存しない
"""
