...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @media print {
    ...
    /* 印刷時にブラウザヘッダー/フッター分だけ全体を縮小・下にずらしてページ内に収める */
    .a4-page {
      transform: scale(0.94) translateY(8mm);
...
<div class="a4-page">
  ...
  <div class="overlay-layer">
    ...
    ${(() => {
      ...
      if (crossYear) {
        // 終了年BOX：step2EndMの直上に白字で「2027年」（6mm下げ）
        const endYearBox = { left: B.step2EndM.left, top: B.step2EndM.top - 5.5 + 6, w: B.step2EndM.w, h: 5.5 };
        const endMonthBox = { ...B.step2EndM, top: B.step2EndM.top + 6 };
        return makeBox(endYearBox, `${endYear}年`, 13, 700, '#ffffff', debug)
