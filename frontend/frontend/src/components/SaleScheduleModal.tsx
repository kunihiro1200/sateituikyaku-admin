...
const BOXES = {
  ...
  // ④ 最低価格：左4mm・下3mm
  minPrice:     { left: 54, top: 187.0, w: 57,  h: 7.0 },
  ...
  step3Year:    { left: 14, top: 205.5, w: 36, h: 5.5 },
  step3Month:   { left: 14, top: 212.5, w: 36, h: 9.5 },
  step4Year:    { left: 14, top: 240.5, w: 36, h: 5.5 },
  step4Month:   { left: 14, top: 247.5, w: 36, h: 8.0 },
} as const;
