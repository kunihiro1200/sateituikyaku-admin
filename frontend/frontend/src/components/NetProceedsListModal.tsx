...
<div class="a4">
  ...
  <div class="layer">
    ...
    ${p.taxMode === 'none_empty' ? npBox(86, 142, 35, 8, p.emptyItemLabel || '解体費用', 12, 700, '#ffffff', debug, 'emptyHeader', 'justify-content:center;font-family:\'Noto Sans JP\',\'Hiragino Kaku Gothic Pro\',\'Meiryo\',sans-serif;') : ''}
