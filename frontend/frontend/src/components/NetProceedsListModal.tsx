  ...
  <div class="layer">
    ...
    ${p.rows.length > 0 ? (() => {
      ...
      return [
        ...
        npBox(124, rowTop, 30, rowH, p.taxMode !== 'none' ? fmtM(row.transferTax, true) : '―', 8, 600, '#1a1a1a', debug, '譲渡所得税'),
        npBox(156, rowTop, 42, rowH, fmtM(row.netProceeds),  9, 900, '#c0392b', debug, '手残り金額'),
      ].join('');
    })() : ''}
