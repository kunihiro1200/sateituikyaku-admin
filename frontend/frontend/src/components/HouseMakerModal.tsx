...
const DATA: Record<string, HouseMakerContent> = {
  ...
  '三越商事': {
    makerName: '三越商事大分', tagline: '大分市戸建申請数No.1・制震標準装備のコスパ住宅',
    sections: [
      { title: '構造・耐震性', points: ['「制震装置（ダンパー）」を標準装備し、地震の揺れを吸収・低減（耐震＋制震の二重構造）', '繰り返しの地震にも建物ダメージが蓄積しにくい制震構造を全棟標準採用', '2024年大分市戸建住宅建築申請数No.1の実績が施工品質の信頼を裏付ける'] },
      { title: '断熱・省エネ性能', points: ['現場発泡の硬質ウレタンフォーム「アクアフォーム」を採用し、隙間なく充填する高気密・高断熱仕様', '樹脂サッシを標準採用し、結露防止と断熱性能を両立', '「WOO（ウー）」プランでは太陽光発電＋高断熱の組み合わせで水道・光熱費「実質ゼロ」を目指すZEH住宅を実現'] },
      { title: 'このメーカーならではの強み', points: ['大分エリア自社保有土地物件数No.1の圧倒的な土地提案力で、土地探しから家づくりをワンストップで対応', '建売住宅にも注文住宅と同じ最新設備・構造を採用し、コストを抑えながら高品質を実現', '45年以上の地域密着の歴史と豊富な施工実績で大分の地盤・気候を熟知', '「RaKuSHiA（ラクシア）」完全自由設計から「LACIEL（ラシェル）」家事ラク規格住宅まで多彩なプランラインナップ'] },
      { title: '品質・保証・アフターサービス', points: ['45年以上の歴史を持つ大分地場の老舗住宅会社として長期にわたるアフターサービス体制を確立', '「KAKOI（カコイ）」プランなど独自商品開発力でライフスタイルに合わせた多様な住まいを提案', '地元密着ゆえの迅速な対応と、土地・建物・不動産まで一貫したサポートが可能'] },
      { title: '資産価値・売却時のポイント', points: ['制震装置標準装備は繰り返しの地震後も建物の損傷が少なく、中古市場での構造的な安心感として直接アピールできる', 'アクアフォーム＋樹脂サッシの高断熱仕様は光熱費の安さとして買主の毎月のランニングコスト削減に直結', '大分市内での圧倒的な施工実績と知名度が、地元買主からの信頼・安心感につながる'] },
    ],
    summary: '制震標準装備と高断熱仕様が、大分の地で45年以上愛され続ける三越商事の家の証です',
    buyerSummary: '三越商事大分の中古住宅は、制震ダンパー標準装備＋アクアフォーム高断熱という二重の安心が特徴。大分市戸建申請数No.1の実績を持つ地元老舗工務店が手がけた、コスパと品質を両立した物件です。',
  },
  'GIJ株式会社': {
  ...
  'オーヴィジョン': {
    makerName: 'オーヴィジョン（O-VISION）', tagline: '九州・山口エリア発・駅近立地×ZEH基準の次世代ファミリーマンション',
    sections: [
      { title: '構造・耐震性', points: ['1フロア3〜4戸という少戸数設計で独立性が高く、角住戸率が高い配置を実現', 'フラットフロアでバリアフリーに配慮した設計を採用し、段差のない安全な住空間を提供', 'オートロック・TVドアホンなど充実したセキュリティ設備を標準装備'] },
      { title: '断熱・省エネ性能', points: ['「ZEH-M Oriented」認定を取得した最新物件も展開し、業界基準を上回る省エネ性能を実現', '高効率給湯器・LED照明・節水設備を標準導入し、地球にやさしい次世代基準「0-VISION」を体現', '環境負荷を抑えたZEH-M基準への対応で光熱費削減と環境配慮を両立'] },
      { title: 'このメーカーならではの強み', points: ['株式会社エストラストが展開する九州・山口エリア特化のマンションブランド', '駅近・ショッピングセンター隣接など「都心隣接」の生活利便性の高い立地に厳選して出店', '全室南向き配置など日当たりを重視した設計で、採光・通風が確保された快適な住空間を提供', '1フロア3〜4戸の少戸数設計により、大規模マンションにはないプライベート感と静粛性を実現'] },
      { title: '品質・保証・アフターサービス', points: ['フィオレストーン天板・食洗機・浄水器一体型シャワー水栓・ガス温水式浴室暖房乾燥機など分譲ならではの高品質設備を標準仕様として採用', 'エストラストグループによるアフターサービス体制で購入後も安心のサポートを提供', '九州・山口エリアに根ざした地域密着の開発・管理体制で迅速な対応が可能'] },
      { title: '資産価値・売却時のポイント', points: ['駅近・生活利便施設隣接の立地は資産価値が落ちにくく、中古市場でも高い需要が見込める', 'ZEH-M基準対応の省エネ性能は光熱費の安さとして買主へのアピールポイントになる', '1フロア少戸数・角住戸率の高さは静粛性とプライバシーを重視する買主層に強く訴求できる', '分譲グレードの高品質設備は内覧時に買主の印象に強く残り成約につながりやすい'] },
    ],
    summary: '駅近立地と省エネ性能・高品質設備の三拍子が、中古市場でも高い評価を生みます',
    buyerSummary: 'オーヴィジョンの中古マンションは、駅近・生活利便性の高い立地にZEH-M基準の省エネ性能と分譲グレードの高品質設備が揃った物件。1フロア3〜4戸の少戸数設計でプライバシーが高く、光熱費の安さと快適な住環境が長期にわたって維持されます。',
  },
  '積水ハイム': {
