...
export interface CategoryCounts {
  ...
  sellerPortalAttention?: number; // 売却サポートページ：対応が必要（決済希望月の未確認入力、または売主からの未読質問）
}
