...
export interface CategoryCounts {
  ...
  ieulCompetitor?: number;    // イエウール他決？（大分・非FI）
  fi_ieulCompetitor?: number; // イエウール他決？（福岡・FI）
}
