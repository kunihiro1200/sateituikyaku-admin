...
import AttachedDocument2Page from './pages/AttachedDocument2Page';
...
function App() {
  ...
  return (
    <GoogleMapsProvider>
      ...
      />
      <Route
        path="/shared-items/sales-meeting-agenda"
        element={
          <ProtectedRoute>
      ...
      />
      <Route
        path="/shared-items/sales-meeting-stats"
        element={
          <ProtectedRoute>
            <SalesMeetingContractStatsPage />
          </ProtectedRoute>
        }
      />
      <Route
        path="/shared-items/sales-meeting-sales-stats"
        element={
          <ProtectedRoute>
            <SalesMeetingSalesStatsPage />
          </ProtectedRoute>
        }
      />
      <Route
        path="/shared-items/sales-meeting-loss-analysis"
        element={
          <ProtectedRoute>
