...
# -*- coding: utf-8 -*-
"""
バグ条件探索テストファイルを UTF-8 で作成するスクリプト
seller-nearby-buyer-email-subject-land-fix
"""
...
function generateSubjectBuggy(address: string, _effectivePropertyType: string | null | undefined): string {
  // バグあり: effectivePropertyType を参照せず固定文字列を返す
...
output_path = 'src/__tests__/seller-nearby-buyer-email-subject-land-bug-exploration.test.ts'
