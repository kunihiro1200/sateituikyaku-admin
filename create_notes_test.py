...
# -*- coding: utf-8 -*-
"""
PropertyListingDetailPage.notes.test.tsx を UTF-8 で作成するスクリプト
"""
...
# 出力先ディレクトリ
output_dir = 'frontend/frontend/src/pages/__tests__'
output_file = os.path.join(output_dir, 'PropertyListingDetailPage.notes.test.tsx')
...
print(f'テストファイルを作成しました: {output_file}')

# エンコーディング確認
with open(output_file, 'rb') as f:
    content = f.read()
print(f'BOM チェック: {repr(content[:3])}')  # b'imp' などであればOK
