...
ALTER TABLE sellers
  ...
  ADD COLUMN IF NOT EXISTS exclusion_action TEXT,
  ...
  ADD COLUMN IF NOT EXISTS duplicate_confirmed_by TEXT,
  ADD COLUMN IF NOT EXISTS contract_year_month TEXT;
