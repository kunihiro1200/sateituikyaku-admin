// Migration 041: Add property_listings table
...
async function runMigration() {
  console.log('Running migration 041: Add property_listings table...\n');

  const sqlPath = path.join(__dirname, '041_add_property_listings.sql');
