...
-- ============================================================================
-- 14. Update Status Constraint to Include Existing Japanese Values
-- ============================================================================

-- Drop existing constraint
ALTER TABLE sellers DROP CONSTRAINT IF EXISTS sellers_status_check;

-- Add new constraint with both English and Japanese status values
-- This preserves existing data while allowing new English values
