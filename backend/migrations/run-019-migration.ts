...
async function runMigration() {
  try {
    ...
    // Read SQL file
    const sqlPath = path.join(__dirname, '019_add_calendar_webhook_channels.sql');
    ...
    console.log('  - Added indexes for employee_id, expiration, and channel_id');
    console.log('  - Added foreign key constraint to employees table');
    console.log('');
    console.log('🎉 Database is now ready for Google Calendar webhook notifications!');
