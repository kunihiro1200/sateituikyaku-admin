...
async function diagnoseAA12766() {
  ...
  // 4. PropertyDistributionAreaCalculatorで再計算
  console.log('【配信エリア再計算】');
  try {
    ...
    console.log('計算結果:');
    console.log(`  cityWideAreas: ${result.cityWideAreas || '(なし)'}`);
    console.log(`  radiusAreas: ${result.radiusAreas || '(なし)'}`);
