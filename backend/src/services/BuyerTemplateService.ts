...
`,
      ...
      // 12. 内覧前ヒアリング
      {
        id: 'buyer_pre_viewing_hearing',
        category: '買主',
        type: '内覧前ヒアリング',
        subject: '内覧のご希望ありがとうございます。事前確認事項につきまして（㈱いふう）',
        content: `<<●氏名・会社名>>様

内覧の日程が決まりましたので、ご案内をスムーズに進めるため、
下記の項目について事前にお知らせいただけますと幸いです。
そのまま空欄にご記入いただき、このメールにご返信ください。
