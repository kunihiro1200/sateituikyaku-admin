...
export class SharedItemsService {
  ...
  private static readonly FIELD_KEY_MAP: Record<string, string> = {
    ...
    'image_comment4': '画像コメント４',
    'image_comment5': '画像コメント５',
    'image_comment6': '画像コメント６',
    'image_comment7': '画像コメント７',
    'image_comment8': '画像コメント８',
    'image_comment9': '画像コメント９',
    'image_comment10': '画像コメント１０',
    'url': 'URL',
