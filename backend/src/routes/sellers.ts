// Seller routes - sidebar-counts endpoint is authentication-free (redeploy: 2026-08-31)
...
router.get('/:sellerNumber/ieul-sheet-info', async (req: Request, res: Response) => {
  ...
  try {
    ...
    const sheetRowNumber = rowOffset + 2; // ヘッダー=1行目、データ=2行目～なので +2
