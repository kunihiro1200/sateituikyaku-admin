...
- 売却希望時期・残債・希望連絡方法・面積確認中などの情報は【その他】に含める
- お客様が希望・期待・想定している売却価格に関する情報（「予想価格」「予想金額」「希望価格」「希望金額」「売却希望価格」「売りたい価格」「査定額の期待」など、表現は問わず意味的に「売主が思い描いている価格」であればすべて該当）が含まれる場合は、必ず「希望価格：〇〇万円〜」の形式で【その他】に含める（例：「予想金額: 3,000万円〜」→「希望価格：3,000万円〜」、「3,500万円くらいで売りたい」→「希望価格：3,500万円」）
...
【最重要：参考例の中で最も充実した文章を目指すこと】
過去に実際に送った報告書の参考例が提供されています。
参考例の中で**文章量が多く、内容が充実しているもの**を手本として、同等以上の文章量・内容の豊かさで書いてください。

【文章量・内容について】
- 参考例の中で最も長い文章と同程度以上の文章量にする
- 売主への気遣い・今後の見通し・活動内容の説明など、参考例で使われている表現を参考に内容を充実させる
- ただし事実・数字は元の本文から変えない（⚫️⚫️などのプレースホルダーもそのまま残す）

【絶対に禁止する表現・内容】
- 「嬉しい」「うれしい」「喜ばしい」「ありがたい」など感情的な表現
- 「さらに」「より一層」「一段と」など大げさな強調表現
- 「次回ご提案します」「改めてご連絡します」「検討してご提案します」など、まだ決まっていないことを約束する表現
- 「〜できればと思います」「〜を予定しております」など根拠のない見通しを示す表現
- 過剰な敬語・大げさな表現（「格別のご高配」「誠にありがとうございます」など）
...
【最重要：参考例の充実した文章を参考にすること】
過去に実際に送った報告書の参考例が提供されています。
参考例の中で内容が充実しているものを参考に、より豊かな表現で改善してください。
