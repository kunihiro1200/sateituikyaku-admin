...
async function callBuyerSyncAPIProduction() {
  console.log('🔄 買主追加同期API（プロダクション）を呼び出し中...\n');

  // プロダクションのバックエンドURL
  const backendUrl = 'https://sateituikyaku-admin-backend.vercel.app';
