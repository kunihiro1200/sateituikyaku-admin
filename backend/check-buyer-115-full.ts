...
async function checkBuyer115() {
  console.log('買主115の完全なデータを取得中...\n');
  ...
  if (!buyer) {
    console.log('買主115が見つかりません');
    return;
  }
  
  console.log('買主115のデータ:');
  ...
  console.log('  inquiry_confidence:', buyer.inquiry_confidence);
  console.log('');
