...
exports.validateBuyerNumber = validateBuyerNumber;
exports.validateBuyerId = validateBuyerId;
exports.uuidValidationMiddleware = uuidValidationMiddleware;
exports.multiUuidValidationMiddleware = multiUuidValidationMiddleware;
/**
 ...
 */
function validateBuyerNumber(value) {
    if (!value || typeof value !== 'string') {
        return false;
    }
 ...
 */
function uuidValidationMiddleware(paramName = 'id') {
    return (req, res, next) => {
 ...
 * @returns Express middleware function
 */
function multiUuidValidationMiddleware(paramNames) {
    return (req, res, next) => {
        const invalidParams = [];
