...
exports.duplicateDetectionService = exports.DuplicateDetectionService = void 0;
...
class DuplicateDetectionService {
     ...
     */
    async checkDuplicateByPhone(phoneNumber, excludeId) {
     ...
     * @returns Array of matching sellers
     */
    async checkDuplicateByEmail(email, excludeId) {
        // checkDuplicates に委譲（全件復号比較方式）
     ...
     */
    async recordDuplicateHistory(currentSellerId, pastSellerId, matchType) {
        try {
     ...
     */
    async getPastOwnerAndPropertyInfo(phoneNumber, email) {
        try {
