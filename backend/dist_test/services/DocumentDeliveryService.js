...
exports.documentDeliveryService = exports.DocumentDeliveryService = void 0;
...
class DocumentDeliveryService {
     ...
     */
    async recordEmailSentDate(sellerId, sentDate) {
        try {
     ...
     */
    async recordMailSentDate(sellerId, sentDate) {
        try {
            const { error } = await supabase
                .from('sellers')
     ...
     */
    async setMailingStatus(sellerId, status) {
        try {
            const { error } = await supabase
                .from('sellers')
     ...
     */
    async setValuationMethod(sellerId, method) {
        try {
            const { error } = await supabase
                .from('sellers')
     ...
     */
    async setAlternativeMailingAddress(sellerId, address) {
        try {
            const { error } = await supabase
                .from('sellers')
     ...
     */
    async updateDocumentDelivery(sellerId, updates) {
        try {
            const updateData = {};
     ...
     */
    async getDocumentDelivery(sellerId) {
        try {
...
exports.DocumentDeliveryService = DocumentDeliveryService;
// Export singleton instance
exports.documentDeliveryService = new DocumentDeliveryService();
