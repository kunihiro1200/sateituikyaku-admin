...
exports.BuyerTemplateService = void 0;
/**
 * 買主テンプレートサービス
...
`,
     ...
     * @returns 置換後の文字列
     */
    replacePlaceholders(template, buyer, employee) {
        let result = template;
        // 買主情報の置換
...
exports.BuyerTemplateService = BuyerTemplateService;
