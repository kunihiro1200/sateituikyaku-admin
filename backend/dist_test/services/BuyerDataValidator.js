...
exports.BuyerDataValidator = void 0;
/**
 * 買主データの検証を行うサービス
 */
class BuyerDataValidator {
    ...
    validateEmail(value) {
        if (!value)
            return true; // null/undefinedは許可（オプショナル）
        const str = String(value).trim();
        if (str === '')
            return true; // 空文字列は許可
        // 基本的なメールアドレス形式チェック
...
exports.BuyerDataValidator = BuyerDataValidator;
