...
exports.AthomeDataService = void 0;
...
class AthomeDataService {
     ...
     */
    async getAthomeData(propertyNumber, propertyType, storageLocation = null) {
        try {
            // Check cache first
            ...
            if (gyomuData.spreadsheetUrl) {
                panoramaUrl = await this.getPanoramaUrlFromSpreadsheet(propertyNumber, gyomuData.spreadsheetUrl);
            }
     ...
     */
    async getPanoramaUrlFromSpreadsheet(propertyNumber, spreadsheetUrl) {
        try {
            // スプレッドシートIDを抽出
...
exports.AthomeDataService = AthomeDataService;
