...
exports.ImageIdentifierService = exports.ImageCategory = void 0;
/**
 * 画像カテゴリ
 */
var ImageCategory;
(function (ImageCategory) {
    ImageCategory["EXTERIOR"] = "exterior";
    ImageCategory["INTERIOR"] = "interior"; // メイン室内（リビング・キッチン）
...
class ImageIdentifierService {
     ...
     */
    identifyImageCategory(fileName) {
     ...
     */
    selectBestImage(images, category) {
        if (images.length === 0) {
            return null;
        }
...
exports.ImageIdentifierService = ImageIdentifierService;
