...
exports.PropertyListingSpreadsheetSync = void 0;
/**
 * 物件リストスプレッドシート同期サービス
 *
...
class PropertyListingSpreadsheetSync {
    constructor(sheetsClient, supabase) {
        this.propertyNumberColumn = '物件番号';
     ...
     * @returns 同期結果
     */
    async syncToSpreadsheet(propertyNumber) {
        try {
     ...
     */
    async findRowIndex(propertyNumber) {
        try {
     ...
     */
    async syncConfirmationToSpreadsheet(propertyNumber, confirmation) {
        try {
     ...
     */
    async syncConfirmationFromSpreadsheet() {
        try {
...
exports.PropertyListingSpreadsheetSync = PropertyListingSpreadsheetSync;
