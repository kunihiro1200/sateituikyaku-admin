...
exports.ManualSyncService = void 0;
...
class ManualSyncService {
    constructor(syncService, logger, supabase) {
     ...
     * 手動同期を実行
     */
    async executeManualSync(mode = 'incremental') {
        // 同時実行チェック
        if (this.isRunning) {
        ...
        try {
            ...
            // ログを完了
            await this.logger.completeSyncLog(logId, failureCount === 0 ? 'success' : 'failure', successCount, failureCount > 0 ? `${failureCount} failures` : undefined);
            return {
...
exports.ManualSyncService = ManualSyncService;
