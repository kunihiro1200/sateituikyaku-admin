...
exports.MultiplePropertyNumberParser = void 0;
...
class MultiplePropertyNumberParser {
     ...
     * 複数の物件番号を検証
     */
    static validateAll(propertyNumbers) {
...
exports.MultiplePropertyNumberParser = MultiplePropertyNumberParser;
