...
exports.sellerNumberService = exports.SellerNumberService = void 0;
...
class SellerNumberService {
     ...
     */
    async isSellerNumberUnique(sellerNumber) {
        try {
     ...
     */
    async sellerNumberExists(sellerNumber) {
        try {
            const { data, error } = await supabase
                .from('sellers')
                .select('id')
    ...
    async generateWithRetry(maxRetries = 3) {
        ...
        throw new Error(`Failed to generate seller number after ${maxRetries} attempts: ${lastError?.message}`);
    }
}
exports.SellerNumberService = SellerNumberService;
// Export singleton instance
exports.sellerNumberService = new SellerNumberService();
