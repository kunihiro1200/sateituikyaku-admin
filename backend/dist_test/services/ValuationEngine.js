...
exports.valuationEngine = exports.ValuationEngine = void 0;
/**
...
class ValuationEngine {
    constructor() {
        ...
        this.LAND_PRICE_PER_SQM = 150000; // Base land price per square meter (円/㎡)
        this.BUILDING_PRICE_PER_SQM = 200000; // Base building price per square meter (円/㎡)
        this.DEPRECIATION_RATE = 0.015; // 1.5% per year
        this.MIN_VALUATION_MULTIPLIER = 0.85; // 85% for minimum
        this.MAX_VALUATION_MULTIPLIER = 1.15; // 115% for maximum
    }
    /**
     ...
     * @returns Multiplier
     */
    getStructureMultiplier(structure) {
        switch (structure) {
            case '木造':
                return 0.9;
            case '軽量鉄骨':
     ...
     */
    validateValuationOrder(amounts) {
     ...
     * @returns Report URL
     */
    async generateValuationReport(valuationId) {
...
exports.valuationEngine = new ValuationEngine();
