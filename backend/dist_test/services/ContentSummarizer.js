...
exports.ContentSummarizer = exports.SummaryCategory = void 0;
var SummaryCategory;
(function (SummaryCategory) {
    SummaryCategory["NEXT_ACTION"] = "next_action";
    SummaryCategory["SITUATION"] = "situation";
    SummaryCategory["OWNER"] = "owner";
    SummaryCategory["TIMING"] = "timing";
    SummaryCategory["REASON"] = "reason";
    SummaryCategory["PROPERTY"] = "property";
    SummaryCategory["CONFIDENCE"] = "confidence";
    SummaryCategory["CONTACT"] = "contact";
    SummaryCategory["PERSONALITY"] = "personality";
    SummaryCategory["PROBLEM"] = "problem";
    SummaryCategory["CONDITION"] = "condition";
    SummaryCategory["OTHER"] = "other";
})(SummaryCategory || (exports.SummaryCategory = SummaryCategory = {}));
class ContentSummarizer {
     ...
     * @private
     */
    filterByCategory(sentences, category) {
        switch (category) {
     ...
     * @private
     */
    filterConfidenceInfo(sentences) {
        const filtered = [];
        // 文脈から確度を判断
        for (const sentence of sentences) {
            // 「★希望連絡時間」は確度ではないので除外
    ...
    getKeywordsForCategory(category) {
        const keywordMap = {
            ...
            [SummaryCategory.OWNER]: ['名義', '所有者', '共有名義', '相続', '本人ではない', '決定権'],
     ...
     */
    hasCategoryKeywords(text, category) {
        const keywords = this.getKeywordsForCategory(category);
...
exports.ContentSummarizer = ContentSummarizer;
