...
exports.visitService = exports.VisitService = void 0;
...
class VisitService {
     ...
     */
    async scheduleVisit(sellerId, visitData) {
        try {
            const updateData = {};
            ...
            const { data, error } = await supabase
                ...
                .update(updateData)
                .eq('id', sellerId)
                .select(`visit_acquisition_date, visit_date, visit_time, visit_day_of_week,
     ...
     * @returns Updated visit information
     */
    async updateVisit(sellerId, updates) {
        try {
            const updateData = {};
     ...
     */
    async calculateVisitRatio(employeeId, startDate, endDate) {
        try {
     ...
     */
    async checkVisitConflict(assigneeId, visitDate, visitTime) {
        try {
