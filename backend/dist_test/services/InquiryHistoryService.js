...
exports.InquiryHistoryService = void 0;
...
class InquiryHistoryService {
     ...
     * 時系列順（降順）でソート
     */
    async getInquiryHistories(sellerId) {
     ...
     * 問合せ履歴を作成
     */
    async createInquiryHistory(request) {
        const { data, error } = await this.supabase
            .from('inquiry_histories')
            .insert({
     ...
     */
    async updateCurrentStatus(sellerId, inquiryHistoryId) {
     ...
     * 問合せ履歴を更新
     */
    async updateInquiryHistory(id, request) {
        const updateData = {};
...
exports.InquiryHistoryService = InquiryHistoryService;
