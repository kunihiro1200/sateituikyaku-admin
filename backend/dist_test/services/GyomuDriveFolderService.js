...
exports.GyomuDriveFolderService = void 0;
 ...
 */
class GyomuDriveFolderService {
    constructor() {
        this.GYOMU_FOLDER_ID = '1d9oHRSQ1_UAC5XakBLijUsendj0ZxD4F';
        this.cacheTimestamp = 0;
        this.CACHE_TTL = 30 * 60 * 1000; // 30分（フォルダ検索は重いのでキャッシュを長めに）
        this.cache = new Map();
    }
    /**
    ...
    async initializeDrive() {
        ...
        try {
            ...
            const absolutePath = path_1.default.resolve(serviceAccountKeyPath);
     ...
     */
    async findSpreadsheetByPropertyNumber(propertyNumber) {
        try {
            // キャッシュチェック
            ...
            if (files.length > 1) {
                console.warn(`[GyomuDriveFolderService] Multiple spreadsheets found for ${propertyNumber}:`, files.map((f) => f.name));
     ...
     */
    selectBestMatch(propertyNumber, files) {
...
exports.GyomuDriveFolderService = GyomuDriveFolderService;
