...
class CancellationService {
     ...
     */
    async recordCancelNoticeAssignee(sellerId, assignee) {
        try {
            const { data, error } = await supabase
                .from('sellers')
                .update({ cancel_notice_assignee: assignee })
                .eq('id', sellerId)
                .select(`cancel_notice_assignee, exclusive_script, price_loss_list_entered,
     ...
     * @returns Updated cancellation information
     */
    async recordExclusiveScript(sellerId, script) {
        try {
            const { data, error } = await supabase
                .from('sellers')
     ...
     * @returns Updated cancellation information
     */
    async markPriceLossListEntered(sellerId, entered) {
        try {
            const { data, error } = await supabase
                .from('sellers')
     ...
     * @returns Updated cancellation information
     */
    async recordCompanyIntroduction(sellerId, introduction) {
        try {
            const { data, error } = await supabase
                .from('sellers')
     ...
     * @returns Updated cancellation information
     */
    async recordPropertyIntroduction(sellerId, introduction) {
        try {
            const { data, error } = await supabase
                .from('sellers')
     ...
     */
    async getCancellationInfo(sellerId) {
        try {
            const { data, error } = await supabase
                .from('sellers')
                .select(`cancel_notice_assignee, exclusive_script, price_loss_list_entered,
     ...
     * @returns Updated cancellation information
     */
    async updateCancellationInfo(sellerId, updates) {
        try {
            const updateData = {};
     ...
     */
    async getSellersWithoutPriceLossEntry() {
        try {
            const { data, error } = await supabase
                .from('sellers')
                .select(`id, seller_number, name, phone_number, status,
     ...
     */
    async getCommonExclusiveScripts() {
        try {
            const { data, error } = await supabase
                .from('sellers')
