...
class CommentSorter {
     ...
     */
    sortCommentsAndActivities(comments, activities) {
        const entries = [];
        // Process comments
     ...
     */
    filterByDateRange(entries, from, to) {
...
exports.CommentSorter = CommentSorter;
