...
const column_mapping_json_1 = __importDefault(require("../config/column-mapping.json"));
/**
 * カラムマッパー
 *
...
class ColumnMapper {
    constructor() {
        this.spreadsheetToDb = column_mapping_json_1.default.spreadsheetToDatabase;
        this.dbToSpreadsheet = column_mapping_json_1.default.databaseToSpreadsheet;
        this.typeConversions = column_mapping_json_1.default.typeConversions;
        this.requiredFields = column_mapping_json_1.default.requiredFields;
    }
    /**
     ...
     */
    convertValueToSheet(value, targetType) {
        if (value === null || value === undefined) {
            return '';
        }
        if (!targetType) {
     ...
     * スプレッドシートの行から物件情報を抽出
     */
    extractPropertyData(sheetRow, sellerId) {
