...
exports.PropertyDetailsService = void 0;
...
class PropertyDetailsService {
     ...
     */
    async upsertPropertyDetails(propertyNumber, details) {
        try {
            // 既存のデータを取得
     ...
     * 物件の追加詳細情報を削除
     */
    async deletePropertyDetails(propertyNumber) {
        try {
            const { error } = await this.supabase
                .from('property_details')
                .delete()
...
exports.PropertyDetailsService = PropertyDetailsService;
