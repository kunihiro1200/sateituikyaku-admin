...
exports.WorkTaskUpcomingDeadlineNotificationService = void 0;
...
const isWithinDays = (dateStr, daysAhead) => {
 ...
 */
class WorkTaskUpcomingDeadlineNotificationService {
    constructor() {
    ...
    async getTargets() {
        ...
        for (const task of data || []) {
            // ルール1: サイト登録締め日リマインダー
            if (isNotBlank(task.site_registration_deadline) &&
            ...
            // ルール3: 媒介作成締め日リマインダー
            if (isNotBlank(task.mediation_deadline) &&
...
exports.WorkTaskUpcomingDeadlineNotificationService = WorkTaskUpcomingDeadlineNotificationService;
// サイト登録締め日の対象開始日（2026-04-25以降のみ）
WorkTaskUpcomingDeadlineNotificationService.SITE_REG_START_DATE = new Date('2026-04-25T00:00:00+09:00');
