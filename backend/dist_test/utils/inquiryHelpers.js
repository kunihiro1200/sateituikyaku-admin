...
exports.determineInquirySource = determineInquirySource;
exports.generateBuyerNumber = generateBuyerNumber;
/**
 * 電話番号を正規化する
 *
 * - ハイフン、空白、括弧を除去
 ...
 */
function determineInquirySource(property) {
 ...
 */
function generateBuyerNumber(columnEValues) {
    // 数値のみを抽出
