...
exports.BUYER_COLUMN_MAPPINGS = void 0;
exports.getDbColumn = getDbColumn;
exports.getAppsheetColumn = getAppsheetColumn;
exports.BUYER_COLUMN_MAPPINGS = [
    // 基本情報
 ...
 */
function getDbColumn(appsheetColumn) {
    const mapping = exports.BUYER_COLUMN_MAPPINGS.find(m => m.appsheetColumn === appsheetColumn);
    return mapping?.dbColumn || null;
}
/**
 * DBカラム名からAppSheetカラム名を取得
 */
function getAppsheetColumn(dbColumn) {
    const mapping = exports.BUYER_COLUMN_MAPPINGS.find(m => m.dbColumn === dbColumn);
