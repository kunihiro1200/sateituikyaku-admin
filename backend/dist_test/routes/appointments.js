 ...
 */
router.post('/', [
    (0, express_validator_1.body)('sellerId').isUUID().withMessage('Invalid seller ID'),
    ...
    try {
        ...
        const appointment = await calendarService.createAppointment(appointmentRequest, assignedEmployee.id, seller.name, seller.phoneNumber, property.address, seller.sellerNumber // 売主番号を追加
        );
