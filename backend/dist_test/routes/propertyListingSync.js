...
const PropertyListingRestSyncService_1 = require("../services/PropertyListingRestSyncService");
...
const syncService = supabaseUrl && supabaseKey
    ? new PropertyListingRestSyncService_1.PropertyListingRestSyncService({
        supabaseUrl,
        supabaseKey,
