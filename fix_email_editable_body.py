...
# -*- coding: utf-8 -*-
"""
DistributionConfirmationModal.tsx を修正:
- onBodyChange プロップを追加
- 本文を TextField で編集可能にする
- useEffect で bodyPreview が変わったら内部 state を更新
"""

import os

filepath = 'frontend/frontend/src/components/DistributionConfirmationModal.tsx'
