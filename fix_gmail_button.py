...
# -*- coding: utf-8 -*-
"""
GmailDistributionButton.tsx を修正する：
1. generatePriceChangeText の重複削除
2. props に salesPrice, previousSalesPrice, propertyType を追加
3. テンプレートのプレースホルダー置換を統一
4. 新着物件テンプレートと公開前配信テンプレートに対応
"""
