    ...
    for idx, url in enumerate(image_urls):
        try:
            ...
            output = replicate.run(
                ...
                input={
                    "image": url,
                    "prompt": "same room interior, very minimal simple furniture, one or two basic pieces, clean modern style, natural lighting, different angle, professional real estate photo",
                    "negative_prompt": "complex furniture, cluttered, decorations, ornate, busy, multiple furniture pieces, completely different room, luxury items, expensive furniture, logo, watermark, text",
