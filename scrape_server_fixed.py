...
def save_to_supabase(data: dict, region: str = 'oita', process_images_flag: bool = False) -> str:
    ...
    # OpenAI画像処理
    print(f'[DEBUG] save_to_supabase: process_images_flag={process_images_flag}, images count={len(images)}')
...
class ScrapeHandler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        try:
            ...
            print(f'[DEBUG] process_images_flag type: {type(process_images_flag)}, value: {process_images_flag}')
